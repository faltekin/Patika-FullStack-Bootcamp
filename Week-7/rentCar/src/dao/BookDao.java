...
public class BookDao {
    ...
    public Book match(ResultSet rs) throws SQLException {       // Veri tabanındaki verilerle book nesnesi içerisinde neye karşılık geldiği bakılır
        Book book = new Book();
        ...
        book.setIdno(rs.getString("book_noid"));
