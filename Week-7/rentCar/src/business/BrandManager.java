...
public class BrandManager {
    ...
    public ArrayList<Object[]> getForTable(int size){
        ...
        for (Brand brand: this.findAll()){          // Column sayısı kadar içeride bir obje oluşturduk
    ...
    public boolean delete(int id){
        ...
        for (Model model : this.modelManager.getByListBrandId(id)){   // İki taraftada silinebilmesi için gerekli
